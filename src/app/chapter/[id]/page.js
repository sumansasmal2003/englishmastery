...
import { ArrowLeft, BookOpen, Loader2, Layers, CheckCircle2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-zinc-200 font-sans selection:bg-indigo-500/30 selection:text-indigo-600 dark:selection:text-indigo-200 transition-colors">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 pt-32 pb-20">
                ...
                <motion.div key={uIndex} variants={itemVariants} className="relative">
                    ...
                    {unit.activities && unit.activities.length > 0 ? (
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-zinc-500 text-sm mt-1 max-w-md">
                                            Test your understanding of <span className="font-semibold text-zinc-700 dark:text-zinc-300">"{unit.title}"</span> with {unit.activities.length} practice exercises.
                                        </p>
                                    </div>
                                </div>
                                <button className="w-full sm:w-auto px-8 py-3 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-black text-sm font-bold rounded-full hover:bg-black dark:hover:bg-white hover:scale-105 transition-all shadow-lg shadow-zinc-500/10 dark:shadow-none">
                                    Start Practice
                                </button>
                            </div>
                         </div>
                        ...
                        <div className="mt-12 flex items-center justify-center gap-4 opacity-50">
                             ...
                             <span className="text-[10px] text-zinc-400 dark:text-zinc-600 uppercase tracking-widest font-medium">End of Unit {uIndex + 1}</span>
                             <div className="h-px w-12 bg-zinc-300 dark:bg-zinc-700"></div>
                        </div>
                    )}
        ...
        <div className="mt-32 pt-10 border-t border-zinc-200 dark:border-zinc-900 flex justify-center transition-colors">
             <button
                onClick={() => router.push('/')}
                className="group flex items-center gap-2 text-sm text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors"
             >
